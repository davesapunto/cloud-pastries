export default function chocolateChipCookies(){

    return(
  
      <div className = "w-screen xl:h-[300vh]">
        ...
        <div className = "w-screen h-[60vh] mt-20 flex justify-center ">
          ...
          <div className = "w-[24rem] h-[24rem] mt-20">
            <h1 className = "text-4xl mt-8 ml-8 ">Chocolate Chip <br/> Cookie </h1>
            <h1 className = "text-2xl mt-8 ml-8">₱110.00</h1>
          </div>
  
        </div>
  
        <div className = "my-20 w-screen h-[75vh] bg-[#F8F5F0] flex justify-center">
          <h1 className = "text-4xl py-20 px-20">Product <br/> Information</h1>
  
          <div className = "my-8 w-4/6 h-[65vh] border-0 border-l-2 border-black">
